...
class MovieTabState extends Equatable {
  const MovieTabState({required this.status, this.currentindex, this.movies});
  ...
  MovieTabState copyWith({MovieTabStatus? status, int? currentindex, List<MovieEntity>? movies}) =>
      MovieTabState(
  ...
  @override
  List<Object> get props => [status, currentindex ?? 0,movies ?? []];
}
/**
